...
import { FindTracksByPlaylistIds } from './useCases/find-tracks-by-playlist-ids';
...
@Injectable()
export class FindTracksByPlaylistIdsService implements FindTracksByPlaylistIds {
